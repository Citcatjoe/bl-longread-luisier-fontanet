(function($){
    ...
    //     .to($hero, 0.1, { filter: "brightness(1.3)", ease: Power4.easeInOut }, "-=0.3") 
    //     .to($hero, 0.1, { filter: "brightness(1)", ease: Power4.easeInOut }, "-=0.2")
    //     .to($hero, 0.1, { filter: "brightness(1.3)", ease: Power4.easeInOut }, "-=0.05") 
    //     .to($hero, 0.1, { filter: "brightness(1)", ease: Power4.easeInOut }, "-=0.04"); 
